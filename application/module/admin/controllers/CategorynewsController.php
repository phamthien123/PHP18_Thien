...
class CategorynewsController extends Controller{
	...
	public function indexAction(){
		$this->_view->_title 		= 'CategoryNews Manager :: List';
		...
		$this->_view->render('categoryNews/index');
	}
	
	// ACTION: ADD & EDIT GROUP

	public function formAction(){
		$this->_view->_title = 'CategoryNews Manager :: Add';
		
		if(isset($this->_arrParam['id'])){
			$this->_view->_title = 'CategoryNews Manager :: Edit';
		...
		if($this->_arrParam['form']['token'] > 0){
			...
			$validate->addRule('category', 'string', array('min' => 3, 'max' => 255))
		...
		$this->_view->render('categoryNews/form');
	}
