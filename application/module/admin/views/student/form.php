<?php 
	...
	$inputName		= Helper::cmsInput('text', 'form[fullname]', 'fullname', $dataForm['fullname'], 'inputbox required', 40);
	...
	$inputScore		= Helper::cmsInput('text', 'form[score]', 'score', $dataForm['score'], 'inputbox', 10);	
	$inputID		= '';
	$rowID			= '';
	...
	$rowScore		= Helper::cmsRowForm('Score', $inputScore);
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowName . $rowStatus . $rowScore . $rowOrdering . $rowID;?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken;?>
