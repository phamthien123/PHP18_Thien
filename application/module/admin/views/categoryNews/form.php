<?php 
	...
	$inputCategory		= Helper::cmsInput('text', 'form[category]', 'category', $dataForm['category'], 'inputbox required', 40);
	...
	// Row
	$rowCategory		= Helper::cmsRowForm('Category', $inputCategory, true);
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowCategory . $rowStatus  . $rowOrdering . $rowID;?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken;?>
