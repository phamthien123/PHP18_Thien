<?php 
	...
	$inputCodevalue	= Helper::cmsInput('text', 'form[codevalue]', 'codevalue', $dataForm['codevalue'], 'inputbox', 40);
	...
	$rowCodevalue	= Helper::cmsRowForm('Codevalue', $inputCodevalue);
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowCode . $rowStatus . $rowCodevalue . $rowOrdering . $rowID;?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken;?>
