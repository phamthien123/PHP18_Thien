...
<?php 
	...
	$lblCodevalue	= Helper::cmsLinkSort('Codevalue', 'codevalue', $columnPost, $orderPost);
	...
	// Pagination
	$paginationHTML		= $this->pagination->showPagination(URL::createLink('admin', 'coupon', 'index'));
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="title"><?php echo $lblCode;?></th>
                                <th width="10%"><?php echo $lblStatus;?></th>
                                <th width="10%"><?php echo $lblCodevalue;?></th>
				...
				<?php
							if(!empty($this->Items)){
								...
								foreach($this->Items as $key => $value){
									...
									$row		= ($i % 2 == 0) ? 'row0' : 'row1';
									$status		= Helper::cmsStatus($value['status'], URL::createLink('admin', 'coupon', 'ajaxStatus', array('id' => $id, 'status' => $value['status'])), $id);
									...
									$linkEdit	= URL::createLink('admin', 'coupon', 'form', array('id' => $id));
		                           	...
		                           	echo  '<tr class="'.$row.'">
		                                	...
		                                	<td class="center"><a href="'.$linkEdit.'">'.$code.'</a></td>
			                                <td class="center">'.$status.'</td>
											<td class="order">'.$codevalue.'</td>
