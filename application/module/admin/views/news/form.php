<?php 
	...
	$inputTitle		= Helper::cmsInput('text', 'form[title]', 'title', $dataForm['title'], 'inputbox required', 40);
	$inputContent	= Helper::cmsInput('text', 'form[content]', 'content', $dataForm['content'], 'inputbox required', 40);
	...
	if(isset($this->arrParam['id'])){
		...
		$picture	= '<img src="'.UPLOAD_URL . 'news' . DS . '60x90-' . $dataForm['picture'].'">';
		$inputPictureHidden	= Helper::cmsInput('hidden', 'form[picture_hidden]', 'picture_hidden', $dataForm['picture'], 'inputbox', 40);
	}
	
	// Row
	$rowTitle		= Helper::cmsRowForm('Title', $inputTitle, true);
	$rowContent		= Helper::cmsRowForm('Content', $inputContent, true);
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowTitle . $rowContent . $rowStatus . $rowOrdering . $rowPicture . $rowID;?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken;?>
